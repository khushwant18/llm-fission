...
class GPT2Attention(nn.Module):
    def __init__(self, config, is_cross_attention=False, layer_idx=None):
        ...
        if self.is_cross_attention:
            ...
            # self.custom_c_attn = CustomConv1D(3 * self.embed_dim, self.embed_dim)
    ...
    def forward(
        ...
        if encoder_hidden_states is not None:
            ...
            query, key, value = qkv_out.split(self.split_size, dim=2)
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        if token_type_ids is not None:
            token_type_embeds = wte(token_type_ids)
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                print(layer_url_map[i])
                res = requests.post(layer_url_map[i], json={"hidden_states": hidden_states.detach().numpy().tolist(),"index":i})
                res = res.json()['res']
