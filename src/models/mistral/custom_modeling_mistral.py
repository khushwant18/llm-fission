...
class MistralModel(MistralPreTrainedModel):
    ...
    def forward(
        ...
        hidden_states = process_hidden_states(layer_url_map, hidden_states,device_type=device_type, position_ids=position_ids,batch_size=batch_size,seq_length=seq_length)
